...
LNP_TIMESERIES_FILE = "results/lnl_over_time_leave1.csv"	#Generated by likelihood_test_parallel.py
ZSCORE_FILE = "results/std_pace_vector.csv"			#Generated by likelihood_test_parallel.py
...
#Returns:
	#Three dictionaries which contains the values of R(t), keyed by (date, hour, weekday)
	#The dictionaries correspond to three different ways of ocmputing R(t) - full covariance gaussian, independent covariance gaussian, and kernel density estimate
def readLnpTimeseries(filename):
	...
	for (date,hour,weekday,full_lnl,ind_lnl,kern_lnl,global_pace, expected_pace, sd_pace) in r:
		hour = int(hour)
		full_timeseries[(date,hour,weekday)] = float(full_lnl)
		ind_timeseries[(date,hour,weekday)] = float(ind_lnl)
		kern_timeseries[(date,hour,weekday)] = float(kern_lnl)
	return (full_timeseries, ind_timeseries, kern_timeseries)
...
if(__name__=="__main__"):
	...
	(full_lnp_timeseries, ind_lnp_timeseries, kern_lnp_timeseries) = readLnpTimeseries(LNP_TIMESERIES_FILE)
	...
	detectEventsSwitching(full_lnp_timeseries, zscore_timeseries, global_pace_timeseries, OUT_UNFILTERED_EVENTS, OUT_FILTERED_EVENTS, min_event_spacing=6, threshold_quant=.05)
	detectEventsSwitching(kern_lnp_timeseries, zscore_timeseries, global_pace_timeseries, OUT_UNFILTERED_EVENTS_KERN, OUT_FILTERED_EVENTS_KERN, min_event_spacing=6, threshold_quant=.05)
	logMsg("Done.")
